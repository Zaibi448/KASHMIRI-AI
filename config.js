...
// make true if you want auto reply on status 
AUTO_STATUS_MSG: process.env.AUTO_STATUS_MSG || "*SEEN YOUR STATUS BY KASHMIRI-AI 🇵🇰*",
...
BOT_NAME: process.env.BOT_NAME || "KASHMIRI-AI",
...
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*©POWERED BY KASHMIRI-AI*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/hg5hj6.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> I'm alive*KASHMIRI-AI*🇵🇰",
// add alive msg here 
